...
- **New (content-gap pass round 2, 2026-07-12):** [Pillar: International Humanitarian Law explainer hub](content/TODO_pillar_ihl.md)
...
- **[Content Gap Analysis & Forward Roadmap (2026-07-12)](roadmap/TODO_content_gap_analysis.md)** — audit of missing content categories/page types/SEO clusters + prioritized build order
...
- **New (content-gap pass round 2, 2026-07-12):** [Public no-code data explorer](features/TODO_data_explorer.md)
- **New (content-gap pass round 6, 2026-07-12):** [Public conflict-forecasting tournament](features/TODO_forecasting_tournament.md)
...
- **New (content-gap pass, 2026-07-12):** [Live blog / crisis ticker page](pages/TODO_live_blog.md) · [Public widget gallery](pages/TODO_widget_gallery.md) · [Newsletter public archive](pages/TODO_newsletter_archive.md) · [Feeds index](pages/TODO_feeds_index.md)
...
- **New (content-gap pass, 2026-07-12):** [Military acronym lookup](programmatic/TODO_template_acronym.md) · [Before/after imagery article](programmatic/TODO_template_before_after.md)
- **New (content-gap pass round 2, 2026-07-12):** [Conflict-vs-conflict comparison](programmatic/TODO_template_conflict_comparison.md) · [Anniversary / retrospective](programmatic/TODO_template_anniversary.md) · [Scrollytelling data-explainer article](programmatic/TODO_template_scrollytelling.md)
- **New (content-gap pass round 3, 2026-07-12):** [Fact-check / debunk database](programmatic/TODO_template_fact_check.md)
- **New (content-gap pass round 4, 2026-07-12):** [Deepfake case-study showcase](programmatic/TODO_template_deepfake_showcase.md)
...
- **New (content-gap pass, 2026-07-12):** [War crimes & accountability](topical_hubs/TODO_hub_war_crimes.md) · [POW exchange tracker](topical_hubs/TODO_hub_pow_exchange.md) · [Reconstruction & recovery](topical_hubs/TODO_hub_reconstruction.md) · [International aid tracker](topical_hubs/TODO_hub_international_aid.md) · [Peace talks & diplomacy](topical_hubs/TODO_hub_peace_diplomacy.md)
- **New (content-gap pass round 3, 2026-07-12):** [Forced conscription & mobilization](topical_hubs/TODO_hub_conscription.md) · [Press freedom & journalist safety](topical_hubs/TODO_hub_press_freedom.md) · [Foreign fighters & PMC presence](topical_hubs/TODO_hub_foreign_fighters.md) · [Cultural heritage destruction](topical_hubs/TODO_hub_cultural_heritage.md) · [⚠️ CRSV & children-in-conflict (BLOCKED — Ethics Board gate)](topical_hubs/TODO_hub_crsv_children.md)
- **New (content-gap pass round 4, 2026-07-12):** [Climate & resource security](topical_hubs/TODO_hub_climate_conflict.md) · [Space domain & counter-space warfare](topical_hubs/TODO_hub_space_domain.md)
- **New (content-gap pass round 5, 2026-07-12):** [Prisoner treatment & detention conditions](topical_hubs/TODO_hub_detention_conditions.md) · [Transitional justice & reparations](topical_hubs/TODO_hub_transitional_justice.md) · [Arms trade & weapons proliferation (deferred — data source pending)](topical_hubs/TODO_hub_arms_trade.md)
- **New (content-gap pass round 6, 2026-07-12):** [Troll farms & coordinated inauthentic behavior](topical_hubs/TODO_hub_troll_farms.md) · [War economy & illicit trade](topical_hubs/TODO_hub_war_economy_smuggling.md) · [Veterans' post-conflict reintegration](topical_hubs/TODO_hub_veterans_reintegration.md) · [Civil-society advocacy & petition tracker](topical_hubs/TODO_hub_advocacy_tracker.md)
...
| 2.69 | 2026-06-11 | Alerts completion, dashboard widgets, cases/review queue, export/API, map/rendering, AOI/travel risk, verification pipeline, pages/bots/onboarding |
| 2.70 | 2026-06-11 | billing/ (metering: soft/hard caps, burst, carry-over, pool, Stripe wiring, idempotency, PPP pricing), embeds/ (12 modules), marketplace/ (9), cms/ (14, Keystatic), safety/ (12 anti-doxxing), infra/ (12 DevOps specs), product/ (28 roadmap spec files), investor/ (9 pitch-deck), growth/ (13), content/ (10) — ~162 tasks, ~174 new files |
| 2.71 | 2026-06-13 | GDPR/privacy compliance (5 modules: breach-notification/cookie-consent/cross-border/dpia/ropa), transparency (4: ai-disclosure/government-requests/methodology/takedown), SLO/SLA (4: slo-definitions/error-budget/sla-tiers/capacity-planning), on-call ax CLI (7 commands) — 106 tasks, 14 new files |
| 2.72 | 2026-06-13 | URL/Slug hardening (slug-extensions/canonical/locale-url in url-builder pkg), 10 Topical Hub specs (cybersecurity/disinformation/drones/elections/energy-security/humanitarian/maritime/satellite/sanctions/cyber-warfare), SEO trust (eeat/source-profiles/local-seo) — ~99 tasks, 16 new files |
| — | 2026-07-12 | **Content gap analysis pass** (planning only, no code): audited all 690 TODO files + 188 live page routes + taxonomy against a full OSINT-platform content model. Confirmed 8 genuine net-new gaps (not previously specced): war crimes/accountability tracker, POW exchange tracker, reconstruction & recovery tracker, international aid/donor tracker, peace talks & diplomacy tracker, military acronym lookup, live-blog page, public widget gallery — plus 4 "extend existing" gaps (newsletter archive, feeds index, grain-corridor tracker, before/after imagery articles). 11 new TODO files added (5 `topical_hubs/`, 2 `programmatic/`, 4 `pages/`), 2 existing files extended with flagged tasks, `categories_taxonomy/` updated with 5 new proposed sub-categories + 5 new topic clusters (16→21). See [roadmap/TODO_content_gap_analysis.md](roadmap/TODO_content_gap_analysis.md) for the full analysis and prioritized build order. |
| — | 2026-07-12 (round 2) | **Second, deeper content-gap pass** (planning only): re-scanned against data-journalism/historical/comparison/UGC/localization/self-service/climate/legal-education/methodology/new-conflict-onboarding angles. 5 more genuine gaps confirmed (5 candidate angles already fully covered — no action): conflict-vs-conflict comparison hub, IHL/laws-of-war educational pillar, public no-code data explorer, conflict anniversary/retrospective template, scrollytelling data-explainer article template. 5 new TODO files added (3 `programmatic/`, 1 `content/`, 1 `features/`). See [roadmap/TODO_content_gap_analysis.md](roadmap/TODO_content_gap_analysis.md) "Round 2" section. |
| — | 2026-07-12 (round 3) | **Third content-gap pass** (planning only): checked press-freedom, cultural-heritage, landmine/demining, undersea-cable-sabotage, GPS-jamming, nuclear-facility-safety, foreign-fighters/PMC, CRSV/children-in-conflict, fact-check-database, security.txt/accessibility-statement, press-kit, and conscription angles. 4 already fully covered (undersea sabotage, nuclear safety, press kit, security.txt), 2 partially covered (landmine tracker — real sub-hub exists; GPS jamming — dispersed across existing pages, not repackaged). 5 genuine net-new gaps confirmed + 1 flagged **BLOCKED pending Ethics Board review** (CRSV/children-in-conflict — explicitly not to be sequenced by ordinary traffic/effort ranking). 6 new TODO files added (5 `topical_hubs/`, 1 `programmatic/`), 1 existing file (`a11y/TODO_wcag_audit.md`) extended with a public accessibility-statement page task. See [roadmap/TODO_content_gap_analysis.md](roadmap/TODO_content_gap_analysis.md) "Round 3" section. |
| — | 2026-07-12 (round 4) | **Fourth content-gap pass** (planning only): fixed a round-2 oversight (climate/water-as-conflict-driver was flagged missing in round 2 but never given a file) + checked 6 fresh angles (water security, space/ASAT domain, ICS/SCADA attacks, deepfake showcase, foreign election interference, public corrections log). Foreign election interference and public corrections log were both already fully covered (no action). ICS/SCADA confirmed real but weak/dispersed — flagged as a task in the existing `topical_hubs/TODO_hub_cyber_warfare.md` rather than a new file. Only **3** genuine gaps survived this round (down from 8→5→5 in prior rounds) — explicitly noted as a sign the well is running dry: climate & resource security, space domain & counter-space warfare, deepfake case-study showcase. 3 new TODO files added (2 `topical_hubs/`, 1 `programmatic/`), 1 existing file extended. See [roadmap/TODO_content_gap_analysis.md](roadmap/TODO_content_gap_analysis.md) "Round 4" section — **recommends this be the last scan-only round; further passes should wait for build progress.** |
| — | 2026-07-12 (round 5) | **Fifth content-gap pass** (planning only, user explicitly requested another broad scan despite round 4's recommendation to pause). Checked 8 fresh angles (detention-conditions monitoring, arms trade, ransomware-for-profit, data-quality transparency, transitional justice/reparations, energy/commodity market impact, "how we're different" trust page, disability-in-humanitarian-content). 4 of 8 already fully covered or not a clean gap (data-quality transparency — already shipped in the annual transparency report; energy/commodity impact — already shipped, more thorough than expected via the traders/finance persona system; "how we're different" — dispersed across existing about/competitor pages, not a clean gap; ransomware — real but dispersed, flagged in-place). 3 genuine net-new gaps confirmed: prisoner treatment/detention-conditions monitoring, transitional justice & reparations tracker, arms trade & proliferation tracker (deferred pending a SIPRI/UN-Comtrade-style data-source integration, same treatment as round 3's cultural-heritage tracker). 1 more gap (disability in humanitarian content) resolved as an extension of the existing humanitarian hub rather than a new file. 3 new TODO files added (`topical_hubs/`), 2 existing files extended (`topical_hubs/TODO_hub_humanitarian.md`, `topical_hubs/TODO_hub_cybersecurity.md`). See [roadmap/TODO_content_gap_analysis.md](roadmap/TODO_content_gap_analysis.md) "Round 5" section. |
| — | 2026-07-12 (round 6) | **Sixth content-gap pass** (planning only, user again requested another broad scan). Checked 8 fresh angles (shadow-fleet tanker tracking, troll-farm/CIB actor-tracking, veterans reintegration, SAR/evacuation logistics, renewables-targeting, public forecasting tournament, advocacy/petition tracker, war-economy/smuggling). Broke the decline trend — found **5 genuinely missing** (higher than rounds 4-5), 1 dispersed (SAR/evacuation), 2 already fully covered (shadow-fleet tanker tracking was already a dedicated, thorough sub-hub; renewables-targeting already has its own FAQ'd sub-page — neither folded generically into parent hubs as suspected). 5 new TODO files added (4 `topical_hubs/`, 1 `features/`: troll farms, war economy/illicit trade — notably this fills an already-anticipated-but-unwired taxonomy stub `economy-logistics-chains`, veterans reintegration, civil-society advocacy tracker, public forecasting tournament), 1 existing file extended (`topical_hubs/TODO_hub_humanitarian.md`, SAR/evacuation flagged in-place). See [roadmap/TODO_content_gap_analysis.md](roadmap/TODO_content_gap_analysis.md) "Round 6" section. |
